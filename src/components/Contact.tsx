              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    rows={6}
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-brand-primary focus:border-transparent transition-all duration-200 resize-none"
                ...
                <button
                  type="submit"
                  className="w-full bg-brand-primary text-white font-semibold px-8 py-4 rounded-lg hover:bg-red-800 hover:shadow-lg transition-all duration-300 shadow-md"
                >
                  Send Message
                </button>
              </form>
